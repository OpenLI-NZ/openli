...
enum {
    ...
    GTPV2_MODIFY_BEARER_REQUEST = 34,
    GTPV2_MODIFY_BEARER_RESPONSE = 35,
    GTPV2_DELETE_SESSION_REQUEST = 36,
    GTPV2_DELETE_SESSION_RESPONSE = 37,
    GTPV2_MODIFY_BEARER_COMMAND = 64,
    GTPV2_MODIFY_BEARER_FAILURE_INDICATION = 65,
    GTPV2_DELETE_BEARER_COMMAND = 66,
    GTPV2_DELETE_BEARER_FAILURE_INDICATION = 67,
    GTPV2_CREATE_BEARER_REQUEST = 95,
    GTPV2_CREATE_BEARER_RESPONSE = 96,
    GTPV2_UPDATE_BEARER_REQUEST = 97,
    GTPV2_UPDATE_BEARER_RESPONSE = 98,
    GTPV2_DELETE_BEARER_REQUEST = 99,
    GTPV2_DELETE_BEARER_RESPONSE = 100,
};
