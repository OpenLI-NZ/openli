...
openli_epoll_ev_t *create_openli_timer(int epoll_fd, void *state,
	...
	openli_epoll_ev_t *newtimer = NULL;
	int sock = -1;

	newtimer = (openli_epoll_ev_t *)malloc(sizeof(openli_epoll_ev_t));
	if (!newtimer) {
		return NULL;
	}
...
openli_epoll_ev_t *create_openli_fdevent(int epoll_fd, void *state,
	...
	openli_epoll_ev_t *newev = NULL;
	struct epoll_event epollev;

	newev = (openli_epoll_ev_t *)malloc(sizeof(openli_epoll_ev_t));
	if (!newev) {
		return NULL;
	}
